  ...
  const contentData = {
    ...
    upload: [
      {
        ...
        a: "지금은 <b>PDF 파일만 올릴 수 있어요.</b> 보험사 앱·홈페이지에서 PDF로 받아 올려주세요.\n이미지로 받았다면, 선명한 파일을 하나의 PDF로 합쳐서 올려주세요."
      },
      {
        q: "보험증권 여러 개를 동시에 올릴 수 있나요?",
        a: "네, 여러 보험사 증권을 <b>동시에</b> 올릴 수 있어요.\n증권만 올릴 경우 최대 3개, 약관과 함께 올릴 경우 1개만 가능해요. 올린 증권은 대시보드에서 한눈에 볼 수 있어요."
      },
      {
        q: "스캔 파일도 올릴 수 있나요?",
    ...
    result: [
      ...
      },
      {
        ...
        a: "네, 분석한 내용은 저장돼요. 단, PDF 원본 파일은 분석이 끝나는 즉시 삭제돼요.\n저장되는 건 PDF에서 추출한 텍스트뿐이고, 이름, 주민번호 같은 중요 개인정보는 <b>마스킹 처리</b>돼요.\n덕분에 다음에 다시 오셔도 파일을 올리지 않아도 바로 질문할 수 있어요."
      }
    ],
    privacy: [
      {
